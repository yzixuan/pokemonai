...
buf += '<p><span class="pokemonicon" style="margin:0 auto;background:transparent url(showdown/sprites/bwicons-sheet.png?v0.8.5) no-repeat scroll -288px -424px"></span> Bear with us as we freak out.</p>';
