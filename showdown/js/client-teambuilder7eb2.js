(function(exports, $) {
	...
	var TeambuilderRoom = exports.TeambuilderRoom = exports.Room.extend({
		...
		updateTeamList: function() {
			...
			if (!teams) {
				buf = '<div class="pad"><p>Loading...</p>'
				this.$el.html(buf);
				return;
			}
			buf = '<div class="pad"><p>Welcome to the teambuilder!</p>'
			buf += '<ul>';
			...
			if (!teams.length) {
				...
				buf += '<li><em>You have no teams currently.</em></li>';
			} else {
		...
		updateTeamView: function() {
			...
			if (this.exportMode) {
				...
				if (!this.curTeam.team.length) {
					buf += '<li><em>You have no pokemon currently.</em></li>';
				}
